...
FORMULA_FILE="$PROJECT_ROOT/homebrew-tap/Formula/axon.rb"
...
echo "  2. Commit and push to tap repository:"
echo -e "     ${YELLOW}cd homebrew-tap${NC}"
echo -e "     ${YELLOW}git add Formula/axon.rb${NC}"
echo -e "     ${YELLOW}git commit -m \"Update AXON formula SHA256 for v${VERSION}\"${NC}"
echo -e "     ${YELLOW}git push origin main${NC}"
echo ""
echo "  3. Update submodule reference in main repo:"
echo -e "     ${YELLOW}cd ..${NC}"
echo -e "     ${YELLOW}git add homebrew-tap${NC}"
echo -e "     ${YELLOW}git commit -m \"Update homebrew-tap submodule\"${NC}"
echo -e "     ${YELLOW}git push origin main${NC}"
echo ""
